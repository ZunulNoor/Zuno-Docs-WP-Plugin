...
function zuno_docs_admin_new_doc_page() {
    ...
    <div class="wrap zuno-docs-new-doc">
        <h1><?php esc_html_e( 'Add New Doc', 'zuno-docs-engine' ); ?></h1>

        <?php if ( $saved ) : ?>
            <div class="notice notice-success is-dismissible">
                <p><?php esc_html_e( 'Doc created successfully.', 'zuno-docs-engine' ); ?>
                <a href="<?php echo esc_url( $edit_link ); ?>"><?php esc_html_e( 'Edit with Gutenberg', 'zuno-docs-engine' ); ?></a></p>
            </div>
        <?php endif; ?>
        ...
        <div class="zuno-docs-new-doc-layout">
            ...
            <div class="zuno-docs-quick-form">
                <h2><?php esc_html_e( 'Quick Create', 'zuno-docs-engine' ); ?></h2>
                <p class="description"><?php esc_html_e( 'Write a title and content below, or use the full editor for advanced formatting.', 'zuno-docs-engine' ); ?></p>
                ...
                <form method="post" action="">
                    ...
                    <table class="form-table">
                        <tr>
                            <th scope="row"><label for="zuno_docs_title"><?php esc_html_e( 'Title', 'zuno-docs-engine' ); ?></label></th>
                            <td><input type="text" id="zuno_docs_title" name="zuno_docs_title" class="regular-text" required /></td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="zuno_docs_category"><?php esc_html_e( 'Category', 'zuno-docs-engine' ); ?></label></th>
                            <td>
                                <select id="zuno_docs_category" name="zuno_docs_category">
                                    <option value=""><?php esc_html_e( '— Select —', 'zuno-docs-engine' ); ?></option>
                        ...
                        <tr>
                            <th scope="row"><label for="zuno_docs_content"><?php esc_html_e( 'Content', 'zuno-docs-engine' ); ?></label></th>
                            <td>
                                <?php
                                wp_editor(
                                    '',
                    ...
                    <p class="submit">
                        <button type="submit" class="button button-primary"><?php esc_html_e( 'Create Doc', 'zuno-docs-engine' ); ?></button>
                    </p>
                </form>
            </div>
            ...
            <div class="zuno-docs-full-editor-link">
                <h2><?php esc_html_e( 'Full Editor', 'zuno-docs-engine' ); ?></h2>
                <p><?php esc_html_e( 'Use the full Gutenberg block editor for rich content, embeds, and advanced layouts.', 'zuno-docs-engine' ); ?></p>
                <a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=zuno_doc' ) ); ?>" class="button button-primary button-hero">
                    <?php esc_html_e( 'Open Gutenberg Editor', 'zuno-docs-engine' ); ?>
                </a>
            </div>
        </div>
    </div>
